...
$sql_food = "SELECT * FROM food WHERE status='pending'";
$result_food = mysqli_query($con, $sql_food);

// Retrieve pending book donations
$sql_books = "SELECT * FROM book WHERE status='pending'";
$result_books = mysqli_query($con, $sql_books);

// Retrieve pending clothes donations
$sql_clothes = "SELECT * FROM clothes WHERE status='pending'";
        ...
        <tbody>
            <?php while ($row = mysqli_fetch_assoc($result_food)) : ?>
                <tr>
                    ...
                    <td>
                        <a class="accept" href="f_accept_donation.php?id=<?php echo $row['f_id']; ?>">Accept</a> |
                        <a class="reject" href="f_reject_donation.php?id=<?php echo $row['f_id']; ?>">Reject</a>
                    </td>
                </tr>
            <?php endwhile; ?>
        </tbody>
        ...
        <tbody>
            <?php while ($row = mysqli_fetch_assoc($result_books)) : ?>
                <tr>
                    ...
                    <td>
                        <a class="accept" href="b_accept_donation.php?id=<?php echo $row['b_id']; ?>">Accept</a> |
                        <a class="reject" href="b_reject_donation.php?id=<?php echo $row['b_id']; ?>">Reject</a>
                    </td>
                </tr>
            <?php endwhile; ?>
        </tbody>
        ...
        <tbody>
            <?php while ($row = mysqli_fetch_assoc($result_clothes)) : ?>
                <tr>
                    ...
                    <td>
                        <a class="accept" href="c_accept_donation.php?id=<?php echo $row['c_id']; ?>">Accept</a> |
                        <a class="reject" href="c_reject_donation.php?id=<?php echo $row['c_id']; ?>">Reject</a>
                    </td>
                </tr>
            <?php endwhile; ?>
        </tbody>
